...
* Fixed colorama gave over bug which was keeping the text colour red, I fixed this by changing the input to include the constant variable Three choices which fixed this issue.
